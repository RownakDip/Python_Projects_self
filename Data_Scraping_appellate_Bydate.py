...
url = f'http://www.supremecourt.gov.bd/web/index.php?page=cause_list.php&menu=00&div_id=1&court_id=1&date1=25/07/2022'
...
for TD in elements:
    ...
    #col4=str(col4).split(">")[1].split("<")[0]
    col4=str(col4).split(">")[1].split("<")[0]+str(col4).split(">")[1].split("<")[0]+str(col4).split(">")[2].split("<")[0]+str(col4).split(">")[4].split("<")[0]+str(col4).split(">")[5].split("<")[0]
    i=i+1
